...
import { SystemIdOrComponentId } from "./SystemAndComponent.ts";
...
export class Suc implements Entity<SucId> {
  ...
  constructor(
    readonly id: SucId,
    readonly dependences: SystemDependence[],
    readonly obj: SUCYamlObject,
  ) {
    this.name = obj.name;
  ...
  static create(
    obj: SUCYamlObject,
    usecaseMap: { [key: string]: SUCSummaryYamlObject },
  ) {
